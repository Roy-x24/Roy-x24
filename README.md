...
🧠 Vibe      : "No solo escribo código — construyo soluciones."
```
...
<table width="100%">
  ...
  <tr><td colspan="2"><div style="height: 2px; background: #1e293b;"></div></td></tr>
  <tr>
    <td align="center" width="140">
...
| Skill | Progress |
|:-----:|:--------:|
| ⚡ **Full Stack Engineering** | ![90%](https://progress-bar.dev/90/?title=&width=400&color=10b981) |
| 🏗️ **Software Architecture** | ![85%](https://progress-bar.dev/85/?title=&width=400&color=059669) |
| ☁️ **Cloud Computing** | ![70%](https://progress-bar.dev/70/?title=&width=400&color=0ea5e9) |
| 🔒 **Cybersecurity** | ![65%](https://progress-bar.dev/65/?title=&width=400&color=8b5cf6) |
| 🧠 **Problem Solving** | ![95%](https://progress-bar.dev/95/?title=&width=400&color=f59e0b) |
